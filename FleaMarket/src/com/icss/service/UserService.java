...
public class UserService {
	...
	// 个人信息修改后的保存
	public boolean storeInformation(String id, String name, String sex, int year, int month, int day, String telephone)
			throws SQLException {
		return (userDao.setName(id, name) && userDao.setSex(id, sex) && userDao.setBirthday(id, year, month, day)
				&& userDao.setTelphone(id, telephone));
	}
}
