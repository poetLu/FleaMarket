		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<script type="text/javascript">
					function modify() {
						var oldPwd = document
								.getElementById("user-old-password").value;
						var newPwd = document
								.getElementById("user-new-password").value;
						var confirmPwd = document
								.getElementById("user-confirm-password").value;
						if (!oldPwd) {
							alert("请输入原登录密码");
						} else if (!newPwd) {
							alert("请输入新密码");
