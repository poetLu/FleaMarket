	...
	<header>
							...
							<form class="am-form am-form-horizontal">
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" placeholder="<%=userDao.getName(userId) %>">
									</div>
								</div>
								<div class="am-form-group">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content birth">
								<div class="birth-select">
									<input type="" name="" id="year" size="10" placeholder="<%=calendar.get(Calendar.YEAR) %>"> <label>年</label>
								</div>
								<div class="birth-select2" style="margin-left: -15px">
									<input type="" name="" id="month" size="10" placeholder="<%=calendar.get(Calendar.MONTH)+1 %>"> <label>月</label>
								</div>
								<div class="birth-select2">
									<input type="" name="" id="day" size="10" placeholder="<%=calendar.get(Calendar.DAY_OF_MONTH) %>"> <label>日</label>
								</div>
							</div>
						</div>
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input id="user-phone" type="tel" placeholder="<%=userDao.getTelephone(userId) %>">
							</div>
						</div>
						<div class="info-btn">
		...
		<script type="text/javascript">
			function modify(){
				...
				xhr.open("get","http://localhost:8080/FleaMarket/informationModify?name="+name+"&sex="+sex+"&year="+year+"&month="+month+"&day="+day+"&telephone="+telephone,false);
				xhr.send(null);
