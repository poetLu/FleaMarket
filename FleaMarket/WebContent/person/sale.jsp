												...
												<div class="order-content">
													...
													for (Item item : userDao.getSoldItem(userId)) {
														if(item.getVisible()==0)
															continue;
													%>
													<div class="order-left" id=<%=item.getItemId() %>>
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint"> <img
																		src="../images/<%=itemService.getGoodsAbstractType(item.getItemId())%>.jpg" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
															...
															<li class="td td-price" style="margin-left: -150px">
																<div class="item-price">
																	<%=item.getPrice() * item.getAmount()%>
																</div>
															</li>
															<li class="td td-change" style="margin-left:-30px;margin-top:15px">
																	<div class="am-btn am-btn-danger anniu" id="delete<%=item.getItemId()%>" onclick="hideRecord(this.id)">删除</div>
															</li>
														</ul>
													</div>
													<%
												...
												<div class="order-left" id=<%=item.getItemId() %>>
													<ul class="item-list">
														...
														<li class="td td-change">
															<div class="am-btn am-btn-danger anniu" style="margin-left:-195px;margin-top:15px" id="delete<%=item.getItemId()%>" onclick="deleteRecord(this.id)">删除</div>
														</li>
													</ul>
												</div>
												<%
