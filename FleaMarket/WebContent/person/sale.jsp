...
<div id="light" class="white_content">
	<table>
		<tr>
			<td>
				<label><font color="white">商品类型</font></label>
			</td>
			<td>
				<select id="games">
		...
		<tr>
			<td><font color="white">账号</font></td><td><input type="text" id="account"></td>
		</tr>
		<tr>
...
<script type="text/javascript">
	function sale(){
		...
		if(!account){
			...
			xhr.open("get","http://localhost:8080/FleaMarket/sale?game="+game+"&account="+account+"&password="+password,false);
			xhr.send(null);
		...
		<div class="main-wrap">
			...
			<div class="user-order">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">我的出售</strong> / <small>Sale</small></div>
					<div style="margin-left:940px"><a href="JavaScript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><font color="red">新增商品</font></a></div>
				</div>
				<hr/>
